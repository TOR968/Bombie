class ClickAutomation {
    constructor() {
        ...
        this.buttons = [
            { x: 0.5 * document.getElementById('GameCanvas').offsetWidth, y: document.getElementById('GameCanvas').offsetHeight - 80 },
            { x: 0.5 * document.getElementById('GameCanvas').offsetWidth + 40, y: document.getElementById('GameCanvas').offsetHeight - 80 }
        ];
